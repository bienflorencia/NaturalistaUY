...
#' @param list_of_country_names A country name in English, or a list of country names 
#'
#' @returns A tibble with the country name (`country_name`), and the number of projects on iNaturalist in the country (`n_projects`)
#' @export
#'
#' @examples
#' getiNatProjectsPerPlaceID(getCountryiNatPlaceID('Spain'))
#' getiNatProjectsPerPlaceID(c(getCountryiNatPlaceID('Uruguay'), getCountryiNatPlaceID('Argentina')))
