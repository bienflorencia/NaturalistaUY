# Visualization of iNaturalist data for Uruguay
Find here some scripts for the analysis of [iNaturalist](https://inaturalist.org) data from Uruguay.  

## **Update**
From December 2021 we have a new site for Uruguay, [NaturalistaUY](https://naturalista.uy).

### Figures from NaturalistaUY

- [We reached 40,000 observations]().

### Figures before NaturalistaUY
