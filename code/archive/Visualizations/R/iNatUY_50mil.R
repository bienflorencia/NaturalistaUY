...
iNatUY <- read_csv('data/observations-238584.csv', guess_max = 50100)
...
ggsave(plot = spatialPlot, filename='figs/50mil_spatialPlot.svg', device = 'svg', width=6, height=6, dpi=300)
...
ggsave(plot = taxonPlot, filename='figs/50mil_taxonPlot.svg', device = 'svg', width=8, height=6, dpi=300)
